...
int app_dm_set_ble_adv_data(tBSA_DM_BLE_ADV_CONFIG *p_data)
{
    ...
    bt_config.adv_config.services_128b.list_cmpl = p_data->services_128b.list_cmpl;
    memcpy(bt_config.adv_config.services_128b.uuid128, p_data->services_128b.uuid128, MAX_UUID_SIZE);
