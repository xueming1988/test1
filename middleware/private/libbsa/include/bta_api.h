...
#define BTA_AVRCP_CTL_SERVICE_ID   29          /* AVRCP Controller 0x110F */
...
#define BTA_AVRCP_CTL_SERVICE_MASK  0x20000000  /* AVRCP Controller 0x110F*/
...
enum{
    ...
    PROFILE_TYPE_A2DP_SINK = 0,
    PROFILE_TYPE_A2DP_SOURCE
};
