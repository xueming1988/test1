...
#define BTA_AV_CFG_RSP_EVT      23 
#define BTA_AV_META_RSP_EVT     24      /* metadata response */
...
/* data associated with BTA_AV_CFG_RSP_EVT */
typedef struct
{
    tBTA_AV_HNDL    hndl;
    UINT8 codec[AVDT_CODEC_SIZE];
} tBTA_AV_CFG_RSP;
