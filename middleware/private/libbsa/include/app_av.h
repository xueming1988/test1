...
/* Callback to application for connection events */
typedef void ( tAvCallbackEx)(tBSA_AV_EVT event, tBSA_AV_MSG *p_data,void *args);
...
typedef struct
{
    tBSA_AV_RC_HNDL rc_handle;
    BD_ADDR         peer_addr;
    BOOLEAN support_abs_volume;
}tAPP_AV_RC_PEER_INFO;
...
/*******************************************************************************
 **
 ** Function         app_av_set_audio_path_by_addr
 **
 **
 *******************************************************************************/
