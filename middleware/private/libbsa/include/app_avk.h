...
typedef struct
{
    ...
    int  volChangeLabel;   /* label used for volume change registration. */
    UINT8 playstate;
    UINT8 has_volume_change_;
} tAPP_AVK_CONNECTION;
...
typedef struct
{
    int index; /* current connection index */
...
/**
 ** Description    get connection index by bt addr
 **/
