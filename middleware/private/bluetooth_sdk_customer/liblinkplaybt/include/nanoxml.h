...
Callbacks:
    ...
    attribute_begin - called when a new attribute is encountered. Passes the complete attribute
name.
...
typedef enum { XML_STS_OK = 0, XML_STS_ERR } XML_STATUS;

typedef enum { TOKEN_INVALID, TAGBEGIN, TAGEND, TAGDATA, ATTRIBUTE, ATTRIBUTEVALUE } TOKEN_TYPE;
