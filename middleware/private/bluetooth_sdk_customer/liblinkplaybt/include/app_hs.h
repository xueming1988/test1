...
/* 使能电量显示的功能 */
int app_hs_enable_battery_indicate();

/* 设置电量等级0-9  */
int app_hs_set_battery_indicate(uint level);

/*  linkplay  初始化蓝牙hfp  */
int linkplay_bluetooth_hfp_init();

/*   linkplay  关闭蓝牙hfp  */
void linkplay_bluetooth_hfp_deinit();

/* 外部(按键等)  接听电话 */
int linkplay_bluetooth_hfp_answer_call();

/* 外部(按键等)  挂断电话  */
int linkplay_bluetooth_hfp_hangup_call();
