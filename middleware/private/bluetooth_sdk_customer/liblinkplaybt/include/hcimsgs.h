...
typedef struct
{
    UINT32 tx_bandwidth;
    UINT32 rx_bandwidth;
    tHCI_CODING_FORMAT tx_coding_format;
    tHCI_CODING_FORMAT rx_coding_format;
    UINT16 tx_codec_frame_size;
    UINT16 rx_codec_frame_size;
    UINT32 input_bandwidth;
    UINT32 output_bandwidth;
    tHCI_CODING_FORMAT input_coding_format;
    tHCI_CODING_FORMAT output_coding_format;
...
HCI_API extern BOOLEAN btsnd_hcic_enh_set_syn_conn (UINT16 conn_handle, UINT32 tx_bandwidth,
                                                               UINT32 rx_bandwidth,tHCI_CODING_FORMAT tx_coding_format,
                                                               tHCI_CODING_FORMAT rx_coding_format, UINT16 tx_codec_frame_size,
                                                               UINT16 rx_codec_frame_size, UINT32 input_bandwidth,
                                                               UINT32 output_bandwidth,tHCI_CODING_FORMAT input_coding_format,
                                                               tHCI_CODING_FORMAT output_coding_format, UINT16 input_coded_data_size,
                                                               UINT16 output_coded_data_size, UINT8 input_PCM_data_format,
                                                               UINT8 output_PCM_data_format, UINT8 input_PCM_sample_payload_MSB_position,
                                                               UINT8 output_PCM_sample_payload_MSB_position, UINT8 input_data_path,
                                                               UINT8 output_data_path, UINT8 input_transport_unit_size,
                                                               UINT8 output_transport_unit_size, UINT16 max_latency,
                                                               UINT16 packet_type, UINT8 retransmission_effort);     /* Enhanced setup SCO connection (CSA2) */
HCI_API extern BOOLEAN btsnd_hcic_enh_acc_syn_conn (BD_ADDR bd_addr, UINT32 tx_bandwidth,
                                                               UINT32 rx_bandwidth,tHCI_CODING_FORMAT tx_coding_format,
                                                               tHCI_CODING_FORMAT rx_coding_format, UINT16 tx_codec_frame_size,
                                                               UINT16 rx_codec_frame_size, UINT32 input_bandwidth,
                                                               UINT32 output_bandwidth,tHCI_CODING_FORMAT input_coding_format,
...
HCI_API extern BOOLEAN btsnd_hcic_create_physical_link (UINT8 local_controller_id, UINT8 physical_link_handle,
                                                        UINT8 link_key_length, UINT8 link_key_type,
                                                        AMP_LINK_KEY amp_link_key);
#define HCIC_PARAM_SIZE_CREATE_PHYSICAL_LINK    3 /* + key length */


HCI_API extern BOOLEAN btsnd_hcic_accept_physical_link (UINT8 local_controller_id, UINT8 physical_link_handle,
                                                        UINT8 link_key_length, UINT8 link_key_type,
                                                        AMP_LINK_KEY amp_link_key);
#define HCIC_PARAM_SIZE_ACCEPT_PHYSICAL_LINK    3 /* + key length */


HCI_API extern BOOLEAN btsnd_hcic_disc_physical_link (UINT8 local_controller_id, UINT8 physical_link_handle,
                                                      UINT8 reason);
#define HCIC_PARAM_SIZE_DISC_PHYSICAL_LINK      2


HCI_API extern BOOLEAN btsnd_hcic_create_logical_link (UINT8 local_controller_id, UINT8 physical_link_handle,
                                                       tHCI_EXT_FLOW_SPEC *p_tx, tHCI_EXT_FLOW_SPEC *p_rx);
#define HCIC_PARAM_SIZE_CREATE_LOGICAL_LINK     33


HCI_API extern BOOLEAN btsnd_hcic_accept_logical_link (UINT8 local_controller_id, UINT8 physical_link_handle,
                                                       tHCI_EXT_FLOW_SPEC *p_tx, tHCI_EXT_FLOW_SPEC *p_rx);
#define HCIC_PARAM_SIZE_ACCEPT_LOGICAL_LINK     33


HCI_API extern BOOLEAN btsnd_hcic_disc_logical_link (UINT8 local_controller_id, UINT16 logical_link_handle);
#define HCIC_PARAM_SIZE_DISC_LOGICAL_LINK      2


HCI_API extern BOOLEAN btsnd_hcic_logical_link_cancel (UINT8 local_controller_id,
                                                       UINT8 physical_link_handle, UINT8 fsid);
#define HCIC_PARAM_SIZE_LOGICAL_LINK_CANCEL     2


HCI_API extern BOOLEAN btsnd_hcic_flow_spec_modify (UINT8 local_controller_id, UINT16 handle,
                                                    tHCI_EXT_FLOW_SPEC *p_tx, tHCI_EXT_FLOW_SPEC *p_rx);
#define HCIC_PARAM_SIZE_FLOW_SPEC_MODIFY        34


HCI_API extern BOOLEAN btsnd_hcic_read_local_amp_info (UINT8 local_controller_id);
#define HCIC_PARAM_SIZE_READ_LOCAL_AMP_INFO     0

HCI_API extern BOOLEAN btsnd_hcic_read_local_amp_assoc (UINT8 local_controller_id,
                                                        UINT8 physical_link_handle,
                                                        UINT16 len_so_far, UINT16 max_length);
#define HCIC_PARAM_SIZE_READ_LOCAL_AMP_ASSOC    5

HCI_API extern BOOLEAN btsnd_hcic_write_remote_amp_assoc (UINT8 local_controller_id, UINT8 physical_link_handle,
                                                          UINT16 len_so_far, UINT16 rem_len, UINT8 *p_frag);

/* Not including data fragment itself */
#define HCIC_PARAM_SIZE_WRITE_REMOTE_AMP_ASSOC  5

HCI_API extern BOOLEAN btsnd_hcic_read_logical_link_accept_timeout (UINT8 local_controller_id);

#define HCIC_PARAM_SIZE_READ_LOGICAL_LINK_ACCEPT_TIMEOUT  0

HCI_API extern BOOLEAN btsnd_hcic_write_logical_link_accept_timeout (UINT8 local_controller_id, UINT16 accept_timeout);
#define HCIC_PARAM_SIZE_WRITE_LOGICAL_LINK_ACCEPT_TIMEOUT   2


HCI_API extern BOOLEAN btsnd_hcic_read_location_data (UINT8 local_controller_id);
#define HCIC_PARAM_SIZE_READ_LOCATION_DATA      0

HCI_API extern BOOLEAN btsnd_hcic_write_location_data (UINT8 local_controller_id,
                                                       UINT8 dom_aware, UINT16 dom_cc,
                                                       UINT8 dom_cc_suffix, UINT8 pwr_src);
#define HCIC_PARAM_SIZE_WRITE_LOCATION_DATA     5


HCI_API extern BOOLEAN btsnd_hcic_read_flow_control_mode (UINT8 local_controller_id);

#define HCIC_PARAM_SIZE_READ_FLOW_CONTROL_MODE  0

HCI_API extern BOOLEAN btsnd_hcic_write_flow_control_mode (UINT8 local_controller_id, UINT8 flow_control_mode);

#define HCIC_PARAM_SIZE_WRITE_FLOW_CONTROL_MODE 1

HCI_API extern BOOLEAN btsnd_hcic_read_be_flush_timeout (UINT8 local_controller_id, UINT16 logical_link_handle);

#define HCIC_PARAM_SIZE_READ_BE_FLUSH_TIMEOUT  2

HCI_API extern BOOLEAN btsnd_hcic_write_be_flush_timeout (UINT8 local_controller_id, UINT16 logical_link_handle,
                                                          UINT32 be_flush_timeout);

#define HCIC_PARAM_SIZE_WRITE_BE_FLUSH_TIMEOUT 6

HCI_API extern BOOLEAN btsnd_hcic_short_range_mode (UINT8 local_controller_id, UINT8 physical_link_handle,
                                                    UINT8 short_range_mode);

#define HCIC_PARAM_SIZE_SHORT_RANGE_MODE       2

HCI_API extern BOOLEAN btsnd_hcic_read_data_block_size (UINT8 local_controller_id);

#define HCIC_PARAM_SIZE_READ_DATA_BLOCK_SIZE    0
...
#define HCIC_PARAM_SIZE_WRITE_SYNC_TRAIN_PARAM 9 /* BSA_SPECIFIC */
