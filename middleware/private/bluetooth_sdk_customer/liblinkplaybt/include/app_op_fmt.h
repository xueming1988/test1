...
extern tAPP_OP_STATUS app_op_build_obj(const tAPP_OP_OBJ_TBL *p_bld, UINT8 *p_data, UINT16 *p_len,
                                       tAPP_OP_PROP *p_prop, UINT8 num_prop);

extern tAPP_OP_STATUS app_op_parse_obj(const tAPP_OP_OBJ_TBL *p_prs, tAPP_OP_PROP *p_prop,
                                       UINT8 *p_num_prop, UINT8 *p_data, UINT32 len);
extern tAPP_OP_STATUS app_op_check_property_by_selector(const tAPP_OP_PROP_TBL *p_tbl,
                                                        UINT8 *p_name, tAPP_OP_PROP *p_prop,
                                                        UINT8 num_prop);
