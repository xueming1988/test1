...
**
*******************************************************************************/
extern tAPP_OP_STATUS app_op_build_card(UINT8 *p_card, UINT16 *p_len, tAPP_OP_FMT fmt,
...
**
*******************************************************************************/
extern tAPP_OP_STATUS app_op_build_note(UINT8 *p_note, UINT16 *p_len, tAPP_OP_PROP *p_prop,
                                        UINT8 num_prop);
...
**
*******************************************************************************/
extern tAPP_OP_STATUS app_op_build_cal(UINT8 *p_cal, UINT16 *p_len, tAPP_OP_PROP *p_prop,
...
**
*******************************************************************************/
extern tAPP_OP_STATUS app_op_parse_card(tAPP_OP_PROP *p_prop, UINT8 *p_num_prop, UINT8 *p_card,
                                        UINT32 len);
...
**
*******************************************************************************/
extern tAPP_OP_STATUS app_op_parse_note(tAPP_OP_PROP *p_prop, UINT8 *p_num_prop, UINT8 *p_note,
                                        UINT32 len);
...
**
*******************************************************************************/
extern tAPP_OP_STATUS app_op_parse_cal(tAPP_OP_PROP *p_prop, UINT8 *p_num_prop, UINT8 *p_cal,
