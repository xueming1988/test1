...
int linkplay_bluetooth_av_close(void) { return app_av_close(); }
...
int linkplay_bluetooth_disc_services_by_addr(BD_ADDR bd_addr, tBSA_SERVICE_MASK services,
...
int linkplay_bluetooth_disc_stop_regular(void) { return app_disc_abort(); }

int linkplay_bluetooth_av_stop_play() { return app_av_stop(); }

int linkplay_bluetooth_av_pause_play() { return app_av_pause(); }

int linkplay_bluetooth_av_resume_play() { return app_av_resume(); }
...
int linkplay_bluetooth_av_open_by_addr(BD_ADDR *bd_addr_in, int timeoutms)
{
    return app_av_open(bd_addr_in, timeoutms);
}
