...
static void app_mgt_generic_callback(tBSA_MGT_EVT event, tBSA_MGT_MSG *p_data)
{
    ...
    case BSA_MGT_DISCONNECT_EVT:
        ...
        APP_INFO1("app_mgt_generic_callback BSA_MGT_DISCONNECT_EVT reason:%d",
...
int app_mgt_open(const char *p_uipc_path, tAPP_MGT_CUSTOM_CBACK *p_mgt_callback)
{
    ...
    if (p_uipc_path == NULL) {
        strncpy(bsa_open_param.uipc_path, APP_DEFAULT_UIPC_PATH,
                sizeof(bsa_open_param.uipc_path) - 1);
