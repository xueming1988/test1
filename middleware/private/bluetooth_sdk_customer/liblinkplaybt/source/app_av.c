...
#ifndef APP_AV_FEAT_MASK /* Default: Target (receive command) and Controller (send command)        \
                            enabled and Copy Protection Enabled*/
#define APP_AV_FEAT_MASK                                                                           \
    (BSA_AV_FEAT_RCTG | BSA_AV_FEAT_RCCT | BSA_AV_FEAT_VENDOR | BSA_AV_FEAT_METADATA |             \
...
const short sinwaves[2][64] = {
    {0,     488,   957,   1389,  1768,  2079,  2310,  2452,  2500,  2452,  2310,  2079,  1768,
     1389,  957,   488,   0,     -488,  -957,  -1389, -1768, -2079, -2310, -2452, -2500, -2452,
     -2310, -2079, -1768, -1389, -957,  -488,  0,     488,   957,   1389,  1768,  2079,  2310,
     2452,  2500,  2452,  2310,  2079,  1768,  1389,  957,   488,   0,     -488,  -957,  -1389,
     -1768, -2079, -2310, -2452, -2500, -2452, -2310, -2079, -1768, -1389, -957,  -488},
    {

        0,     244,   488,   722,   957,   1173,  1389,  1578,  1768,  1923,  2079,  2194,  2310,
        2381,  2452,  2476,  2500,  2476,  2452,  2381,  2310,  2194,  2079,  1923,  1768,  1578,
        1389,  1173,  957,   722,   488,   244,   0,     -244,  -488,  -722,  -957,  -1173, -1389,
        -1578, -1768, -1923, -2079, -2194, -2310, -2381, -2452, -2476, -2500, -2476, -2452, -2381,
        -2310, -2194, -2079, -1923, -1768, -1578, -1389, -1173, -957,  -722,  -488,  -244}};
...
#define APP_AV_PLAYTYPE_PCM_DATA 5
...
tBSA_ITEM_PLAYER bsa_av_player1_file = {
    ...
    /* Use AVRC_MJ_TYPE_AUDIO, AVRC_MJ_TYPE_VIDEO, AVRC_MJ_TYPE_BC_AUDIO, or
       AVRC_MJ_TYPE_BC_VIDEO.*/
    (AVRC_MJ_TYPE_AUDIO | AVRC_MJ_TYPE_VIDEO),
    /* Use AVRC_SUB_TYPE_NONE, AVRC_SUB_TYPE_AUDIO_BOOK, or AVRC_SUB_TYPE_PODCAST*/
    AVRC_SUB_TYPE_NONE,
    /* Use AVRC_PLAYSTATE_STOPPED, AVRC_PLAYSTATE_PLAYING, AVRC_PLAYSTATE_PAUSED,
    ...
    AVRC_PLAYSTATE_STOPPED,
    {
        ...
        0x6C, /* octet 7 bit mask: 0=PassThru Vendor, 1=GroupNavi, 2=AdvCtrl, 3=Browsing,
                                   4=Searching, 5=AddToNowPlaying, 6=UID_unique,
                 7=BrowsableWhenAddressed */
    ...
    {/* The player name, name length and character set id.*/
     AVRC_CHARSET_ID_UTF8, 12, (UINT8 *)"File Player"}};
...
tBSA_ITEM_PLAYER bsa_av_player2_media_player = {
    ...
    {/* The player name, name length and character set id.*/
     AVRC_CHARSET_ID_UTF8, 12, (UINT8 *)"Media Player"}};
#if 0
...
tBSA_APP_ITEM_MEDIA song1 = {
    ...
    .name =
        {
            /* The player name, name length and character set id.*/
            AVRC_CHARSET_ID_UTF8, 8, (UINT8 *)"Beat It ",
        },
    .attr_count = 7,
    ...
    .p_attr_list[1] =
        {
            ...
            {/* The player name, name length and character set id.*/
             AVRC_CHARSET_ID_UTF8, 16, (UINT8 *)"Michael Jackson "},
        },
    ...
    .p_attr_list[2] =
        {
            ...
            {/* The player name, name length and character set id.*/
             AVRC_CHARSET_ID_UTF8, 8, (UINT8 *)"Thriller"},
        },
    ...
    .p_attr_list[3] =
        {
            ...
            {/* The player name, name length and character set id.*/
             AVRC_CHARSET_ID_UTF8, 8, (UINT8 *)"SoftRock"},
        },
    ...
    .p_attr_list[4] =
        {
            ...
            {/* The player name, name length and character set id.*/
             AVRC_CHARSET_ID_UTF8, 4, (UINT8 *)"3   "},
        },
    ...
    .p_attr_list[5] =
        {
            ...
            {/* The player name, name length and character set id.*/
             AVRC_CHARSET_ID_UTF8, 4, (UINT8 *)"1   "},
        },
    ...
    .p_attr_list[6] =
        {
            ...
            {/* The player name, name length and character set id.*/
             AVRC_CHARSET_ID_UTF8, 8, (UINT8 *)"269000  "},
        },
...
tBSA_APP_ITEM_MEDIA song2 = {
    ...
    .name =
        {
            /* The player name, name length and character set id.*/
            AVRC_CHARSET_ID_UTF8, 16, (UINT8 *)"Happy Nation    ",
        },
    .attr_count = 7,
    ...
    .p_attr_list[1] =
        {
            AVRC_MEDIA_ATTR_ID_ARTIST,
            {/* The player name, name length and character set id.*/
             AVRC_CHARSET_ID_UTF8, 16, (UINT8 *)"Jonas, Jenny    "},
        },
    ...
    .p_attr_list[2] =
        {
            AVRC_MEDIA_ATTR_ID_ALBUM,
            {/* The player name, name length and character set id.*/
             AVRC_CHARSET_ID_UTF8, 16, (UINT8 *)"Ace of Base     "},
        },
    ...
    .p_attr_list[3] =
        {
            AVRC_MEDIA_ATTR_ID_GENRE,
            {/* The player name, name length and character set id.*/
             AVRC_CHARSET_ID_UTF8, 4, (UINT8 *)"Pop "},
        },
    ...
    .p_attr_list[4] =
        {
            AVRC_MEDIA_ATTR_ID_NUM_TRACKS,
            {/* The player name, name length and character set id.*/
             AVRC_CHARSET_ID_UTF8, 4, (UINT8 *)"2   "},
        },
    ...
    .p_attr_list[6] =
        {
            AVRC_MEDIA_ATTR_ID_PLAYING_TIME,
            {/* The player name, name length and character set id.*/
             AVRC_CHARSET_ID_UTF8, 8, (UINT8 *)"255000  "},
        },
...
tBSA_APP_ITEM_MEDIA song3 = {
    ...
    .name =
        {
            /* The player name, name length and character set id.*/
            AVRC_CHARSET_ID_UTF8, 16, (UINT8 *)"River of Dreams ",
        },
    .attr_count = 7,
    .p_attr_list[0] =
        {
    ...
    .p_attr_list[1] =
        {
            AVRC_MEDIA_ATTR_ID_ARTIST,
            {/* The player name, name length and character set id.*/
             AVRC_CHARSET_ID_UTF8, 16, (UINT8 *)"Billy Joel      "},
        },
    ...
    .p_attr_list[3] =
        {
            AVRC_MEDIA_ATTR_ID_GENRE,
            {/* The player name, name length and character set id.*/
             AVRC_CHARSET_ID_UTF8, 4, (UINT8 *)"Soul"},
        },
    ...
    .p_attr_list[6] =
        {
            AVRC_MEDIA_ATTR_ID_PLAYING_TIME,
            {/* The player name, name length and character set id.*/
             AVRC_CHARSET_ID_UTF8, 8, (UINT8 *)"211000  "},
        },
};

#define BSA_AV_NUMSONGS 3

tBSA_APP_ITEM_MEDIA *bsa_av_songs[] = {&song1, &song2, &song3};
...
#define AVRCP_NOW_PLAYING_FOLDER_ID_FIRST_BYTE                                                     \
    0x02                                          /* First byte of NOW_PLAYING folder UID 0x02     \
                                                     */
...
tBSA_AV_META_PLAYSTAT playst = {
    255000, 120000, BSA_AVRC_PLAYSTATE_STOPPED,
};

BOOLEAN av_connection_state = FALSE;
static tAvCallbackEx *s_pCallback = NULL;

tAPP_THREAD t_app_rc_thread;
static int s_command = 0;
static tAPP_AV_DELAY av_delay;
static int g_av_start_pending = 0;
/*
 * Local functions
 */
static int app_av_uipc_reconfig(void);
int app_av_stop_current(void);
        ...
        if (app_av_cb.connections[index].is_registered) {
            ...
            if (app_av_cb.connections[index].is_open) {
                APP_INFO1("        Connected to %02X:%02X:%02X:%02X:%02X:%02X",
                          app_av_cb.connections[index].bd_addr[0],
                          app_av_cb.connections[index].bd_addr[1],
                          app_av_cb.connections[index].bd_addr[2],
                          app_av_cb.connections[index].bd_addr[3],
                          app_av_cb.connections[index].bd_addr[4],
                          app_av_cb.connections[index].bd_addr[5]);
...
void app_av_cback(tBSA_AV_EVT event, tBSA_AV_MSG *p_data)
{
    ...
    case BSA_AV_OPEN_EVT:
        APP_INFO1("BSA_AV_OPEN_EVT status:%d handle:%d cp:%d aptx:%d sec:%d", p_data->open.status,
                  p_data->open.handle, p_data->open.cp_supported, p_data->open.aptx_supported,
        ...
        if (connection == NULL) {
            ...
            if (p_data->open.status == BSA_SUCCESS) {
                ...
                app_xml_add_trusted_services_db(
                    ...
                    connection->bd_addr, BSA_A2DP_SERVICE_MASK | BSA_AVRCP_SERVICE_MASK,
                    PROFILE_TYPE_A2DP_SINK);
                ...
                for (index = 0; index < APP_NUM_ELEMENTS(app_discovery_cb.devs); index++) {
                    if (!bdcmp(app_discovery_cb.devs[index].device.bd_addr, connection->bd_addr)) {
                        app_xml_update_name_db(
                            app_xml_remote_devices_db, APP_NUM_ELEMENTS(app_xml_remote_devices_db),
                            connection->bd_addr, app_discovery_cb.devs[index].device.name);
                        //  pargs = (void *)app_discovery_cb.devs[index].device.name;
...
/* Check if autoplay is needed */
...
#endif
                    APP_INFO1("SCMS-T: cp_supported = %s",
                              p_data->open.cp_supported ? "TRUE" : "FALSE");
                }
    ...
    case BSA_AV_CLOSE_EVT:
        APP_INFO1("BSA_AV_CLOSE_EVT status:%d handle:%d", p_data->close.status,
                  p_data->close.handle);
        ...
        app_av_cb.open_pending = FALSE;
        g_av_start_pending = 0;
        break;

    case BSA_AV_DELAY_RPT_EVT:
        APP_INFO1("BSA_AV_DELAY_RPT_EVT channel:%d handle:%d delay: %d", p_data->delay.channel,
                  p_data->delay.handle, p_data->delay.delay);
    ...
    case BSA_AV_PENDING_EVT: {
        ...
        bdcpy(p_con->bd_addr, p_data->pend.bd_addr);
        /* Open AV stream */
    ...
    case BSA_AV_START_EVT:
        APP_INFO1("BSA_AV_START_EVT status:%d channel:%x UIPC:%d SCMS:%d,%d", p_data->start.status,
                  p_data->start.channel, p_data->start.uipc_channel, p_data->start.cp_enabled,
            ...
            if (p_data->start.status == BSA_SUCCESS) {
                ...
                default:
                    APP_ERROR1("Unsupported feeding format code: %d",
                               app_av_cb.media_feeding.format);
                    break;
                }

                APP_INFO1("    SCMS-T: cp_enabled = %s, cp_flag = %d",
                          p_data->start.cp_enabled ? "TRUE" : "FALSE", p_data->start.cp_flag);
    ...
    case BSA_AV_STOP_EVT:
        APP_DEBUG1("BSA_AV_STOP_EVT pause:%d Channel:%d UIPC:%d", p_data->stop.pause,
                   p_data->stop.channel, p_data->stop.uipc_channel);
        /* If this is a Point to Point AV connection */
    ...
    case BSA_AV_RC_OPEN_EVT:
        APP_DEBUG1("BSA_AV_RC_OPEN_EVT status:%d handle:%d", p_data->rc_open.status,
        ...
        if (connection == NULL) {
            APP_ERROR1("unknown connection bd addr for %02X:%02X:%02X:%02X:%02X:%02X",
                       p_data->rc_open.peer_addr[0], p_data->rc_open.peer_addr[1],
                       p_data->rc_open.peer_addr[2], p_data->rc_open.peer_addr[3],
                       p_data->rc_open.peer_addr[4], p_data->rc_open.peer_addr[5]);
    ...
    case BSA_AV_RC_CLOSE_EVT:
        APP_DEBUG1("BSA_AV_RC_CLOSE_EVT handle:%d bdaddr %02X:%02X:%02X:%02X:%02X:%02X",
                   p_data->rc_close.rc_handle, p_data->rc_close.peer_addr[0],
                   p_data->rc_close.peer_addr[1], p_data->rc_close.peer_addr[2],
                   p_data->rc_close.peer_addr[3], p_data->rc_close.peer_addr[4],
                   p_data->rc_close.peer_addr[5]);

        connection = app_av_find_connection_by_bd_addr(p_data->rc_close.peer_addr);
        if (connection == NULL) {
            APP_ERROR1("unknown connection bd addr for %02X:%02X:%02X:%02X:%02X:%02X",
                       p_data->rc_close.peer_addr[0], p_data->rc_close.peer_addr[1],
                       p_data->rc_close.peer_addr[2], p_data->rc_close.peer_addr[3],
                       p_data->rc_close.peer_addr[4], p_data->rc_close.peer_addr[5]);
        } else {
    ...
    case BSA_AV_VENDOR_CMD_EVT:
        ...
        APP_DEBUG1("    len=%d, label=%d, code=%d, company_id=0x%x", p_data->vendor_cmd.len,
                   p_data->vendor_cmd.label, p_data->vendor_cmd.code,
    ...
    case BSA_AV_VENDOR_RSP_EVT:
        ...
        APP_DEBUG1("    len=%d, label=%d, code=%d, company_id=0x%x", p_data->vendor_rsp.len,
                   p_data->vendor_rsp.label, p_data->vendor_rsp.code,
    ...
    case BSA_AV_META_MSG_EVT:
        ...
        APP_DEBUG1("    label=%d, pdu=%d, company_id=0x%x", p_data->meta_msg.label,
                   p_data->meta_msg.pdu, p_data->meta_msg.company_id);
    ...
    case BSA_AV_CFG_RSP_EVT:
        APP_DEBUG1("BSA_AV_CFG_RSP_EVT Peer set configuration - codec:[%x:%x:%x:%x:%x:%x]",
                   p_data->cfg_rsp.codec[1], p_data->cfg_rsp.codec[2], p_data->cfg_rsp.codec[3],
                   p_data->cfg_rsp.codec[4], p_data->cfg_rsp.codec[5], p_data->cfg_rsp.codec[6]);
        break;
    ...
    if (s_pCallback)
        s_pCallback(event, p_data, pargs);
}
...
static void app_avk_rc_command_thread(void)
{
    ...
    while ((app_av_get_play_state() == APP_AV_PLAY_STOPPING) &&
           (app_av_get_play_state() != APP_AV_PLAY_STOPPED) && waitcnt < 5) {
        sleep(1);
        waitcnt++;
    }
 ...
 **
 *******************************************************************************/
int app_av_open(BD_ADDR *bd_addr_in, int timeoutms)
{
    int status;
    ...
    if (connect) {
        ...
        while (app_av_cb.open_pending == TRUE && try_count--) {
            usleep(20000);
        }

        p_con = app_av_find_connection_by_bd_addr(open_param.bd_addr);
        if (p_con == NULL || p_con->is_open == FALSE) {
...
int app_av_play_tone(void)
{
    ...
    start_param.feeding_mode =
        app_av_cb.uipc_cfg.is_blocking ? BSA_AV_FEEDING_ASYNCHRONOUS : BSA_AV_FEEDING_SYNCHRONOUS;
    start_param.latency =
        app_av_cb.uipc_cfg.period / 1000; /* convert us to ms, synchronous feeding mode only*/
...
int app_av_play_pcm_data(tBSA_AV_MEDIA_FEED_CFG_PCM *pcm_config)
{
    int status;
    tBSA_AV_START start_param;
    ...
    BSA_AvStartInit(&start_param);
    start_param.media_feeding.format = BSA_AV_CODEC_PCM;
    start_param.media_feeding.cfg.pcm.sampling_freq =
        pcm_config->sampling_freq; /* 44100, 48000 etc */
    start_param.media_feeding.cfg.pcm.num_channel =
        pcm_config->num_channel; /* 1 for mono or 2 stereo */
    start_param.media_feeding.cfg.pcm.bit_per_sample = pcm_config->bit_per_sample;
    start_param.feeding_mode =
        app_av_cb.uipc_cfg.is_blocking ? BSA_AV_FEEDING_ASYNCHRONOUS : BSA_AV_FEEDING_SYNCHRONOUS;
    start_param.latency =
        app_av_cb.uipc_cfg.period / 1000; /* convert us to ms, synchronous feeding mode only*/
    ...
    int delay_cnt = 100; // wait until play stopped
    while (--delay_cnt && app_av_cb.play_state != APP_AV_PLAY_STOPPED) {
        usleep(10000);
    }
    g_av_start_pending = 1;
    ...
    delay_cnt = 100;
    while (--delay_cnt && app_av_cb.play_state != APP_AV_PLAY_STARTED && g_av_start_pending) {
        ...
        if(app_wav_format(app_av_cb.soundfile_list[app_av_cb.file_index], &wav_format) < 0) {
            ...
            switch(wav_format.codec) {
                ...
                case BSA_AV_CODEC_APTX:
                    ...
                    break;
                default:
                    APP_ERROR1("Unsupported codec (x%x) in WAV file (%s)", wav_format.codec,
                               app_av_cb.soundfile_list[app_av_cb.file_index]);
                    format_known = FALSE;
                    break;
            }
            start_param.feeding_mode = app_av_cb.uipc_cfg.is_blocking ? BSA_AV_FEEDING_ASYNCHRONOUS : BSA_AV_FEEDING_SYNCHRONOUS;
 ...
 **
 *******************************************************************************/
int app_av_play_music(tBSA_AV_MEDIA_FEED_CFG_PCM *pcm_config)
{
#ifdef PCM_ALSA
    int status;
...
int app_av_tx_send(UINT8 *audio_buf, int nb_bytes)
{
    UINT16 uipc_error = 0;
    ...
    status = UIPC_Send(app_av_cb.stream_uipc_channel, 0, (UINT8 *)audio_buf, nb_bytes);
    if (status == FALSE) {
        if (UIPC_Ioctl(app_av_cb.stream_uipc_channel, UIPC_READ_ERROR, &uipc_error)) {
            if (uipc_error == UIPC_ENOMEM) {
                printf("UIPC buffer full! Pause playing");
                app_av_pause();
                GKI_delay(3000);
                printf("UIPC buffer full! Resume playing");
                app_av_resume();
            } else {
    ...
    if (app_av_cb.uipc_cfg.is_blocking == FALSE) {
        ...
        app_av_wait_delay(1, &av_delay, &app_av_cb.uipc_cfg);
    }
    /* print once per sec */
    // clock_gettime(CLOCK_MONOTONIC, &newtime);
    // if ((newtime.tv_sec - av_start) > av_elapsed) {
    //  av_elapsed = newtime.tv_sec - av_start;
    //  APP_DEBUG1("Streaming for %d secs", av_elapsed);
    //}
    return 0;
...
int app_av_rc_send_get_element_attributes_vd_response(int index)
{
    ...
    str_len = 0;
    attr_count =
        7; /*  Fill all the media attributes or only those requested by the AVRCP controller */
...
int app_av_rc_send_get_element_attributes_meta_response(int index)
{
    ...
    for (xx = 0; xx < attr_count; xx++) {
        p_attr[xx].name.charset_id =
            bsa_av_songs[p_bsa_av_cb->cur_play]->p_attr_list[xx].name.charset_id;
        ...
        if (bsa_av_songs[p_bsa_av_cb->cur_play]->p_attr_list[xx].name.str_len != 0 &&
            bsa_av_songs[p_bsa_av_cb->cur_play]->p_attr_list[xx].name.p_str) {
            strncpy((char *)p_attr[xx].str,
                    (char *)bsa_av_songs[p_bsa_av_cb->cur_play]->p_attr_list[xx].name.p_str,
                    BSA_AV_META_INFO_LEN_MAX - 1);
            APP_INFO1("Attr ID %d, string name %s",
                      bsa_av_songs[p_bsa_av_cb->cur_play]->p_attr_list[xx].attr_id, p_attr[xx].str);
        }
    }
...
int app_av_rc_send_play_status_meta_response(int index)
{
    ...
    bsa_av_meta_rsp_cmd.label = app_av_cb.label;
    bsa_av_meta_rsp_cmd.param.get_play_status.song_len =
        (UINT32)255000; /*  Sample lenth of song 4' 15 seconds */
    bsa_av_meta_rsp_cmd.param.get_play_status.song_pos =
        (UINT32)120000; /*  Sample current position 2' 00 seconds */
...
int app_av_rc_set_browsed_player_meta_response(int index, tBSA_AV_META_MSG_MSG *pMetaMsg)
{
    ...
    for (xx = 0; xx < BSA_AV_NUM_MPLAYERS; xx++) {
        if (bsa_av_players[xx] && pMetaMsg->player_id == bsa_av_players[xx]->player_id &&
            ...
            strncpy((char *)bsa_av_meta_rsp_cmd.param.browsed_player_status.folder_name_str,
                    "Player 1 files",
                    sizeof(bsa_av_meta_rsp_cmd.param.browsed_player_status.folder_name_str) - 1);
...
int app_av_rc_change_path_meta_response(int index, tBSA_AV_META_MSG_MSG *pMetaMsg)
{
    ...
    /* For this app, will respond that change path is not supported, we have just one level flat
     * directory structure */
...
int app_av_rc_get_folder_items(int index, tBSA_AV_META_MSG_MSG *pMetaMsg)
{
    ...
    if (bsa_av_meta_rsp_cmd.param.get_items_status.scope == AVRC_SCOPE_PLAYER_LIST) {
        ...
        APP_INFO1("GetFolderItems - list player range %d to %d",
                  pMetaMsg->param.get_folder_items.start_item,
                  pMetaMsg->param.get_folder_items.end_item);
        APP_INFO1("num of available players %d", BSA_AV_NUM_MPLAYERS);

        for (xx = pMetaMsg->param.get_folder_items.start_item;
             xx < BSA_AV_NUM_MPLAYERS && xx <= pMetaMsg->param.get_folder_items.end_item; xx++) {
            if (bsa_av_players[xx]) {
                bsa_av_meta_rsp_cmd.param.get_items_status.item_list[xx].item_type =
                    AVRC_ITEM_PLAYER;
                memcpy(&bsa_av_meta_rsp_cmd.param.get_items_status.item_list[xx].u.player,
                       bsa_av_players[xx], sizeof(tBSA_ITEM_PLAYER));
                strncpy((char *)bsa_av_meta_rsp_cmd.param.get_items_status.item_list[xx].item_str,
                        (char *)bsa_av_players[xx]->name.p_str, BSA_AV_ITEM_NAME_LEN_MAX - 1);
                bsa_av_meta_rsp_cmd.param.get_items_status.num_items++;
                APP_INFO1("Media player ID %d, name %s", bsa_av_players[xx]->player_id,
                          bsa_av_players[xx]->name.p_str);
            }
        }
    }
        ...
        for (xx = pMetaMsg->param.get_folder_items.start_item;
             xx < BSA_AV_NUMSONGS && xx <= pMetaMsg->param.get_folder_items.end_item; xx++) {
            if (bsa_av_songs[xx]) {
                bsa_av_meta_rsp_cmd.param.get_items_status.item_list[xx].item_type =
                    AVRC_ITEM_MEDIA;
                memcpy(&bsa_av_meta_rsp_cmd.param.get_items_status.item_list[xx].u.media.uid,
                       bsa_av_songs[xx]->uid, sizeof(tBSA_UID));
                bsa_av_meta_rsp_cmd.param.get_items_status.item_list[xx].u.media.type =
                    bsa_av_songs[xx]->type;
                bsa_av_meta_rsp_cmd.param.get_items_status.item_list[xx].u.media.name.charset_id =
                    bsa_av_songs[xx]->name.charset_id;
                bsa_av_meta_rsp_cmd.param.get_items_status.item_list[xx].u.media.name.str_len =
                    bsa_av_songs[xx]->name.str_len;
                bsa_av_meta_rsp_cmd.param.get_items_status.item_list[xx].u.media.attr_count = 0;

                strncpy((char *)bsa_av_meta_rsp_cmd.param.get_items_status.item_list[xx].item_str,
                        (char *)bsa_av_songs[xx]->name.p_str, BSA_AV_ITEM_NAME_LEN_MAX - 1);
                bsa_av_meta_rsp_cmd.param.get_items_status.num_items++;
        ...
        APP_INFO1("GetFolderItems, scope %d not supported",
                  bsa_av_meta_rsp_cmd.param.get_items_status.scope);
...
int app_av_rc_play_item_meta_response(int index, tBSA_AV_META_MSG_MSG *pMetaMsg)
{
    ...
    APPL_TRACE_DEBUG3("app_av_rc_play_item_meta_response scope:%d, uid[0]:0x%02d, uid[7]:0x%02",
                      pMetaMsg->param.play_item.scope, pMetaMsg->param.play_item.uid[0],
                      pMetaMsg->param.play_item.uid[7]);
    ...
    case AVRC_SCOPE_FILE_SYSTEM:
        ...
        for (xx = 0; xx < BSA_AV_NUMSONGS; xx++) {
            if (memcmp(bsa_av_songs[xx]->uid, pMetaMsg->param.play_item.uid, sizeof(tBSA_UID)) ==
                0) {
...
int app_av_rc_register_notifications(int index, tBSA_AV_META_MSG_MSG *pMetaMsg)
{
    ...
    return app_av_build_notification_response(pMetaMsg->param.reg_notif.event_id,
                                              &bsa_av_meta_rsp_cmd);
}
...
void app_av_rc_complete_notification(UINT8 event_id)
{
    ...
    {
        APPL_TRACE_DEBUG2("Event(0x%x) was registered(0x%x) evt_mask:0x%x", event_id,
 ...
 *******************************************************************************/
static int app_av_build_notification_response(UINT8 event_id,
                                              tBSA_AV_META_RSP_CMD *p_bsa_av_meta_rsp_cmd)
{
    int status;
    ...
    case AVRC_EVT_PLAY_STATUS_CHANGE: /* 0x01 */
        p_bsa_av_meta_rsp_cmd->param.notify_status.param.play_status =
            p_bsa_av_cb->meta_info.play_status.play_status;
        break;

    case AVRC_EVT_TRACK_CHANGE: /* 0x02 */
        p = p_bsa_av_meta_rsp_cmd->param.notify_status.param.track;
        APPL_TRACE_DEBUG2("play_count %d cur_play %d", p_bsa_av_cb->play_count,
                          p_bsa_av_cb->cur_play);
        /* Check whether folder and file is selected or not */
        if (p_bsa_av_cb->play_count == 0) {
            /* If not, add track ID to be 0xFFFFFFFF-FFFFFFFF */
            UINT32_TO_BE_STREAM(
                p, AVRCP_NO_NOW_PLAYING_FOLDER_ID); /* the id from the no now playing folder */
            UINT32_TO_BE_STREAM(
                p, AVRCP_NO_NOW_PLAYING_FILE_ID); /* the id from the no now playing file */
        } else {
            /* If selected, add track ID to be the current playing file ID  */
            UINT32_TO_BE_STREAM(
                p, AVRCP_NOW_PLAYING_FOLDER_ID); /* the id from the now playing folder */
            UINT32_TO_BE_STREAM(p, p_bsa_av_cb->cur_play +
                                       1); /* the id from the current playing file */
        }
        break;
    ...
    case AVRC_EVT_PLAY_POS_CHANGED: /* 0x05 */
        p_bsa_av_meta_rsp_cmd->param.notify_status.param.play_pos =
            p_bsa_av_cb->meta_info.play_status.song_pos;
        break;

    case AVRC_EVT_BATTERY_STATUS_CHANGE: /* 0x06 */
        p_bsa_av_meta_rsp_cmd->param.notify_status.param.battery_status =
            p_bsa_av_cb->meta_info.notif_info.bat_stat;
        break;

    case AVRC_EVT_SYSTEM_STATUS_CHANGE: /* 0x07 */
        p_bsa_av_meta_rsp_cmd->param.notify_status.param.system_status =
            p_bsa_av_cb->meta_info.notif_info.sys_stat;
        break;

    case AVRC_EVT_APP_SETTING_CHANGE: /* 0x08 */
        p_bsa_av_meta_rsp_cmd->param.notify_status.param.player_setting.num_attr =
            p_bsa_av_cb->meta_info.max_attrib_num;
        p_pas_attrib = &p_bsa_av_cb->meta_info.pas_info.equalizer;
        for (xx = 0; xx < p_bsa_av_meta_rsp_cmd->param.notify_status.param.player_setting.num_attr;
             xx++) {
            p_bsa_av_meta_rsp_cmd->param.notify_status.param.player_setting.attr_id[xx] =
                p_pas_attrib->attrib_id;
            p_bsa_av_meta_rsp_cmd->param.notify_status.param.player_setting.attr_value[xx] =
                p_pas_attrib->curr_value;
            p_pas_attrib++;
        }
        break;
    ...
    case AVRC_EVT_ADDR_PLAYER_CHANGE: /* 0x0b */
        p_bsa_av_meta_rsp_cmd->param.notify_status.param.addr_player.player_id =
            p_bsa_av_cb->meta_info.addr_player_id;
        /* UID counter is always 0 for Database Unaware Players */
        p_bsa_av_meta_rsp_cmd->param.notify_status.param.addr_player.uid_counter =
            p_bsa_av_cb->meta_info.cur_uid_counter;
        break;
...
void app_av_rc_change_play_status(UINT8 new_play_status)
{
    if (new_play_status <= (UINT8)AVRC_PLAYSTATE_REV_SEEK) {
        ...
        APPL_TRACE_DEBUG2("play_status = %d/%d", old_play_status,
                          p_bsa_av_cb->meta_info.play_status.play_status);
...
void app_av_rc_addressed_player_change(UINT16 addr_player)
{
    ...
    if ((addr_player != BSA_AV_PLAYER_ID_FILES) && (addr_player != BSA_AV_PLAYER_ID_MPLAYER))
...
void app_av_rc_settings_change(UINT8 setting, UINT8 value)
{
    ...
    if (setting != AVRC_PLAYER_SETTING_EQUALIZER && setting != AVRC_PLAYER_SETTING_REPEAT &&
...
static void app_av_init_meta_data()
{
    ...
    strncpy((char *)p_bsa_av_cb->meta_info.pas_info.equalizer.attrib_str, "Equalizer",
            sizeof(p_bsa_av_cb->meta_info.pas_info.equalizer.attrib_str) - 1);
    strncpy((char *)p_bsa_av_cb->meta_info.pas_info.equalizer.attr_settings[0].val1, "Off",
            sizeof(p_bsa_av_cb->meta_info.pas_info.equalizer.attr_settings[0].val1) - 1);
    strncpy((char *)p_bsa_av_cb->meta_info.pas_info.equalizer.attr_settings[1].val2, "On",
            sizeof(p_bsa_av_cb->meta_info.pas_info.equalizer.attr_settings[1].val2) - 1);

    p_bsa_av_cb->meta_info.pas_info.repeat.attrib_id = 2;
    p_bsa_av_cb->meta_info.pas_info.repeat.curr_value = 2;

    strncpy((char *)p_bsa_av_cb->meta_info.pas_info.repeat.attrib_str, "Repeat",
            sizeof(p_bsa_av_cb->meta_info.pas_info.repeat.attrib_str) - 1);
    strncpy((char *)p_bsa_av_cb->meta_info.pas_info.repeat.attr_settings[0].val1, "Repeat Off",
            sizeof(p_bsa_av_cb->meta_info.pas_info.repeat.attr_settings[0].val1) - 1);
    strncpy((char *)p_bsa_av_cb->meta_info.pas_info.repeat.attr_settings[1].val2, "Repeat Single",
            sizeof(p_bsa_av_cb->meta_info.pas_info.repeat.attr_settings[1].val2) - 1);

    p_bsa_av_cb->meta_info.pas_info.shuffle.attrib_id = 3;
    p_bsa_av_cb->meta_info.pas_info.shuffle.curr_value = 2;

    strncpy((char *)p_bsa_av_cb->meta_info.pas_info.shuffle.attrib_str, "Shuffle",
            sizeof(p_bsa_av_cb->meta_info.pas_info.shuffle.attrib_str) - 1);
    strncpy((char *)p_bsa_av_cb->meta_info.pas_info.shuffle.attr_settings[0].val1, "Shuffle Off",
            sizeof(p_bsa_av_cb->meta_info.pas_info.shuffle.attr_settings[0].val1) - 1);
    strncpy((char *)p_bsa_av_cb->meta_info.pas_info.shuffle.attr_settings[1].val2, "Shuffle All",
            sizeof(p_bsa_av_cb->meta_info.pas_info.shuffle.attr_settings[1].val2) - 1);
    ...
    if (app_av_cb.media_feeding.format == p_format->codec) {
        ...
        case BSA_AV_CODEC_APTX:
            return (app_av_cb.media_feeding.cfg.aptx.sampling_freq == p_format->sample_rate) &&
                   (((app_av_cb.media_feeding.cfg.aptx.ch_mode == A2D_SBC_IE_CH_MD_MONO) ? 1 : 2) ==
                    p_format->nb_channels);
            break;
        default:
 ...
 **
 *******************************************************************************/
int app_av_init(tAvCallbackEx pcb)
{
...
BOOLEAN app_av_is_padding_acceptable(int length, tBSA_AV_MEDIA_FEEDINGS *p_media_feeding)
{
    ...
    case BSA_AV_CODEC_PCM:
        ...
        padding =
            p_media_feeding->cfg.pcm.bit_per_sample * p_media_feeding->cfg.pcm.num_channel / 8;
        break;
...
int app_av_ask_uipc_config(void)
{
    ...
    if ((app_av_cb.media_feeding.cfg.pcm.bit_per_sample == 0) ||
        ...
        APP_INFO0("AV not yet started => let's use default values as feeding example (PCM, 48kHz, "
                  "16bits, Stereo)");
...
int app_av_test_sec_codec(BOOLEAN use_prev_samp_freq)
{
    ...
    APP_INFO1("app_av_test_sec_codec freq:%d, c_m:%d, f_m:%d,lat:%d",
              ...
              start_param.media_feeding.cfg.sec.ch_mode, start_param.feeding_mode,
              start_param.latency);
...
int app_av_change_cp(void)
{
    ...
    APP_INFO1("The current Content Protection Id is=%s ScmsFlag=%d", app_av_get_current_cp_desc(),
              app_av_cb.cp_scms_flag);
 ...
 **
 *******************************************************************************/
UINT8 app_av_get_play_state() { return app_av_cb.play_state; }

UINT8 app_av_get_play_type() { return app_av_cb.play_type; }
int app_av_set_audio_path_by_addr(BD_ADDR bd_addr, BOOLEAN enable)
{
    int ret = 0;
    ...
    /* Add AV service for this devices in XML database */
    ret = app_xml_add_audio_path_db(app_xml_remote_devices_db,
                                    APP_NUM_ELEMENTS(app_xml_remote_devices_db), bd_addr, enable);
...
int app_av_get_audio_path_by_addr(BD_ADDR bd_addr, int *enable)
{
    int index;
    ...
    for (index = 0; index < APP_NUM_ELEMENTS(app_xml_remote_devices_db); index++) {
        if (bdcmp(app_xml_remote_devices_db[index].bd_addr, bd_addr) == 0) {
            *enable = app_xml_remote_devices_db[index].is_audio_path_on;
        }
    }
...
int app_av_find_registered_connection(void)
{

    tAPP_AV_CONNECTION *p_con = app_av_find_connection_by_status(TRUE, FALSE);
    if (p_con == NULL) {
        APP_ERROR0("Current has connection");
        return -1;
    }
