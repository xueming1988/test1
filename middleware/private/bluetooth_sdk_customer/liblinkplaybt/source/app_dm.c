...
int app_dm_set_ble_conn_param(tBSA_DM_BLE_CONN_PARAM *p_req)
{
    ...
    APP_DEBUG1("BDA:%02X:%02X:%02X:%02X:%02X:%02X  ", p_req->bd_addr[0], p_req->bd_addr[1],
               p_req->bd_addr[2], p_req->bd_addr[3], p_req->bd_addr[4], p_req->bd_addr[5]);

    APP_DEBUG1("min_conn_int:%d max_conn_int:%d slave_latency:%d supervision_tout:%d",
               p_req->max_conn_int, p_req->min_conn_int, p_req->slave_latency,
               p_req->supervision_tout);
...
int app_dm_set_ble_adv_data(tBSA_DM_BLE_ADV_CONFIG *p_data)
{
    ...
    memcpy(bt_config.adv_config.service_data_val, p_data->service_data_val,
           p_data->service_data_len);
...
int app_dm_set_ble_adv_param(tBSA_DM_BLE_ADV_PARAM *p_req)
{
    ...
    APP_DEBUG1("BDA:%02X:%02X:%02X:%02X:%02X:%02X  ", p_req->dir_bda.bd_addr[0],
               p_req->dir_bda.bd_addr[1], p_req->dir_bda.bd_addr[2], p_req->dir_bda.bd_addr[3],
