...
#ifdef COMMS_API_V3
    g_sua_info.tlsCertificateFilePath = nullptr; //"/etc/ssl/certs";
    g_sua_info.metricsConfigParameters.certificatesDirectoryPath = COMMS_CERTS_DIR_PATH;
    g_sua_info.metricsConfigParameters.deviceTypeId = g_deviceTypeId;
    g_sua_info.metricsConfigParameters.hostAddress = IOT_HOST_URL;
