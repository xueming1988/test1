...
private:
    ...
    Word16 k_ALPHA;
    Word16 k_ONE_MINUS_ALPHA;

    // Attack time constant
    Word16 k_ATTACK;
    Word16 k_ONE_MINUS_ATTACK;

    // Release time constant
    Word16 k_MIN_RELEASE;
    Word16 k_ONE_MINUS_MIN_RELEASE;

    // Attack time constant for peak tracking
    Word16 k_PEAK_ATTACK;
    Word16 k_ONE_MINUS_PEAK_ATTACK;


    // Release time constant for peak tracking
    Word16 k_PEAK_RELEASE;
    Word16 k_ONE_MINUS_PEAK_RELEASE;


    //Attack and Release TCs for ensemble estimation
    // fast update
    Word16 k_EST_FAST_ATTACK;
    Word16 k_ONE_MINUS_EST_FAST_ATTACK;
    // slow update
    Word16 k_EST_SLOW_ATTACK;
    Word16 k_ONE_MINUS_EST_SLOW_ATTACK;


    // Attack time constant for threshold attack
    Word16 k_THR_ATTACK;
    Word16 k_ONE_MINUS_THR_ATTACK;
    ...
    unsigned int k_MAX_FRAMES_AFTER_LAST_ATTACK;

    // Frames to wait for initially
    unsigned int k_WAIT_FOR_FRAMES;
