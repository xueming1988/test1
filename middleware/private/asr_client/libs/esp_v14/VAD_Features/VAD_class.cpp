...
const Word32 VADClass::k_ENERGY_THRESH = 700000; // 500000 ~= -70 dBFS Square Wave
...
void VADClass::process( Word16 * xInFr, const unsigned int channel, bool& decision) {
