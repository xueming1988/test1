...
typedef struct SipUserAgentStateObserverInterface
{
   ...
   */
  void (*onStateUpdated)(const SipUserAgentState previousSipUserAgentState, const SipUserAgentState currentSipUserAgentState, const char* inboundRingtoneUrl);

#ifdef __cplusplus
  bool operator==(const struct SipUserAgentStateObserverInterface & other) const { return onStateUpdated == other.onStateUpdated; }
#endif
