...
ALEXACOMMSLIB_API ALEXACOMMSLIB_DEPRECATED bool SipUserAgentInterface_create(SipUserAgentInterfaceCreateParameters
        params);
...
ALEXACOMMSLIB_API void SipUserAgentInterface_removeSipUserAgentEventObserver(SipUserAgentEventObserverInterface
        observer);

ALEXACOMMSLIB_API void SipUserAgentInterface_addSipUserAgentStateObserver(SipUserAgentStateObserverInterface observer);

ALEXACOMMSLIB_API void SipUserAgentInterface_removeSipUserAgentStateObserver(SipUserAgentStateObserverInterface
        observer);

ALEXACOMMSLIB_API void SipUserAgentInterface_addSipUserAgentFocusManagerObserver(
    SipUserAgentFocusManagerObserverInterface observer);

ALEXACOMMSLIB_API void SipUserAgentInterface_removeSipUserAgentFocusManagerObserver(
    SipUserAgentFocusManagerObserverInterface observer);

ALEXACOMMSLIB_API void SipUserAgentInterface_addSipUserAgentNativeCallObserver(SipUserAgentNativeCallObserverInterface
        observer);

ALEXACOMMSLIB_API void SipUserAgentInterface_removeSipUserAgentNativeCallObserver(
    SipUserAgentNativeCallObserverInterface observer);
...
ALEXACOMMSLIB_API void SipUserAgentInterface_notifyNativeCallStarted();

ALEXACOMMSLIB_API void SipUserAgentInterface_notifyNativeCallStopped();

ALEXACOMMSLIB_API void SipUserAgentInterface_notifyIncomingNativeCall(const char *name, const char *phoneNumber);
