...
//linkplay customized bonjour SRV
#define kLinkplayBonjourSmallTTL 120UL
#define kLinkplayBonjourSrvType "_linkplay._tcp"
#define kAirplayBonjourSrvType "_airplay._tcp"
#define kHapBonjourSrvType "_hap._tcp"
