...
{
    switch (inFormat) {
    case kAirPlayAudioFormat_PCM_8KHz_16Bit_Mono:
        ASBD_FillPCM(outASBD, 8000, 16, 16, 1);
        break;
    case kAirPlayAudioFormat_PCM_8KHz_16Bit_Stereo:
        ASBD_FillPCM(outASBD, 8000, 16, 16, 2);
        break;
    case kAirPlayAudioFormat_PCM_16KHz_16Bit_Mono:
        ASBD_FillPCM(outASBD, 16000, 16, 16, 1);
        break;
    case kAirPlayAudioFormat_PCM_16KHz_16Bit_Stereo:
        ASBD_FillPCM(outASBD, 16000, 16, 16, 2);
        break;
    case kAirPlayAudioFormat_PCM_24KHz_16Bit_Mono:
        ASBD_FillPCM(outASBD, 24000, 16, 16, 1);
        break;
    case kAirPlayAudioFormat_PCM_24KHz_16Bit_Stereo:
        ASBD_FillPCM(outASBD, 24000, 16, 16, 2);
        break;
    case kAirPlayAudioFormat_PCM_32KHz_16Bit_Mono:
        ASBD_FillPCM(outASBD, 32000, 16, 16, 1);
        break;
    case kAirPlayAudioFormat_PCM_32KHz_16Bit_Stereo:
        ASBD_FillPCM(outASBD, 32000, 16, 16, 2);
        break;
    case kAirPlayAudioFormat_PCM_44KHz_16Bit_Mono:
        ASBD_FillPCM(outASBD, 44100, 16, 16, 1);
        break;
    case kAirPlayAudioFormat_PCM_44KHz_16Bit_Stereo:
        ASBD_FillPCM(outASBD, 44100, 16, 16, 2);
        break;
    case kAirPlayAudioFormat_PCM_44KHz_24Bit_Mono:
        ASBD_FillPCM(outASBD, 44100, 24, 24, 1);
        break;
    case kAirPlayAudioFormat_PCM_44KHz_24Bit_Stereo:
        ASBD_FillPCM(outASBD, 44100, 24, 24, 2);
        break;
    case kAirPlayAudioFormat_PCM_48KHz_16Bit_Mono:
        ASBD_FillPCM(outASBD, 48000, 16, 16, 1);
        break;
    case kAirPlayAudioFormat_PCM_48KHz_16Bit_Stereo:
        ASBD_FillPCM(outASBD, 48000, 16, 16, 2);
        break;
    case kAirPlayAudioFormat_PCM_48KHz_24Bit_Mono:
        ASBD_FillPCM(outASBD, 48000, 24, 24, 1);
        break;
    case kAirPlayAudioFormat_PCM_48KHz_24Bit_Stereo:
        ASBD_FillPCM(outASBD, 48000, 24, 24, 2);
        break;
    case kAirPlayAudioFormat_ALAC_44KHz_16Bit_Stereo:
        ASBD_FillALAC(outASBD, 44100, 16, 2);
        break;
    case kAirPlayAudioFormat_ALAC_44KHz_24Bit_Stereo:
        ASBD_FillALAC(outASBD, 44100, 24, 2);
        break;
    case kAirPlayAudioFormat_ALAC_48KHz_16Bit_Stereo:
        ASBD_FillALAC(outASBD, 48000, 16, 2);
        break;
    case kAirPlayAudioFormat_ALAC_48KHz_24Bit_Stereo:
        ASBD_FillALAC(outASBD, 48000, 24, 2);
        break;
    case kAirPlayAudioFormat_AAC_LC_44KHz_Stereo:
        ASBD_FillAAC_LC(outASBD, 44100, 2);
        break;
    case kAirPlayAudioFormat_AAC_LC_48KHz_Stereo:
        ASBD_FillAAC_LC(outASBD, 48000, 2);
        break;
    case kAirPlayAudioFormat_AAC_ELD_16KHz_Mono:
        ASBD_FillAAC_ELD(outASBD, 16000, 1);
        break;
    case kAirPlayAudioFormat_AAC_ELD_24KHz_Mono:
        ASBD_FillAAC_ELD(outASBD, 24000, 1);
        break;
    case kAirPlayAudioFormat_AAC_ELD_44KHz_Stereo:
        ASBD_FillAAC_ELD(outASBD, 44100, 2);
        break;
    case kAirPlayAudioFormat_AAC_ELD_48KHz_Stereo:
        ASBD_FillAAC_ELD(outASBD, 48000, 2);
        break;
    case kAirPlayAudioFormat_OPUS_16KHz_Mono:
        ASBD_FillOpus(outASBD, 16000, 1);
        break;
    case kAirPlayAudioFormat_OPUS_24KHz_Mono:
        ASBD_FillOpus(outASBD, 24000, 1);
        break;
    case kAirPlayAudioFormat_OPUS_48KHz_Mono:
        ASBD_FillOpus(outASBD, 48000, 1);
        break;
    case kAirPlayAudioFormat_AAC_ELD_44KHz_Mono:
        ASBD_FillAAC_ELD(outASBD, 44100, 1);
        break;
    case kAirPlayAudioFormat_AAC_ELD_48KHz_Mono:
        ASBD_FillAAC_ELD(outASBD, 48000, 1);
        break;
    default:
        return (kUnsupportedErr);
    }
    if (outBitsPerChannel) {
        if ((inFormat == kAirPlayAudioFormat_AAC_LC_44KHz_Stereo) || (inFormat == kAirPlayAudioFormat_AAC_LC_48KHz_Stereo) || (inFormat == kAirPlayAudioFormat_ALAC_44KHz_16Bit_Stereo) || (inFormat == kAirPlayAudioFormat_ALAC_48KHz_16Bit_Stereo) || (inFormat == kAirPlayAudioFormat_AAC_ELD_16KHz_Mono) || (inFormat == kAirPlayAudioFormat_AAC_ELD_24KHz_Mono) || (inFormat == kAirPlayAudioFormat_AAC_ELD_44KHz_Stereo) || (inFormat == kAirPlayAudioFormat_AAC_ELD_48KHz_Stereo) || (inFormat == kAirPlayAudioFormat_OPUS_16KHz_Mono) || (inFormat == kAirPlayAudioFormat_OPUS_24KHz_Mono) || (inFormat == kAirPlayAudioFormat_OPUS_48KHz_Mono) || (inFormat == kAirPlayAudioFormat_AAC_ELD_44KHz_Mono) || (inFormat == kAirPlayAudioFormat_AAC_ELD_48KHz_Mono)) {
            *outBitsPerChannel = 16;
        } else if ((inFormat == kAirPlayAudioFormat_ALAC_44KHz_24Bit_Stereo) || (inFormat == kAirPlayAudioFormat_ALAC_48KHz_24Bit_Stereo)) {
...
AudioFormatID AirPlayCompressionTypeToAudioFormatID(AirPlayCompressionType inCompressionType)
{
    ...
    case kAirPlayCompressionType_PCM:
        formatID = kAudioFormatLinearPCM;
        break;
    case kAirPlayCompressionType_AAC_LC:
        formatID = kAudioFormatMPEG4AAC;
        break;
    case kAirPlayCompressionType_AAC_ELD:
        formatID = kAudioFormatMPEG4AAC_ELD;
        break;
    case kAirPlayCompressionType_OPUS:
...
AirPlayCompressionType AudioFormatIDToAirPlayCompressionType(AudioFormatID inFormatID)
{
    ...
    case kAudioFormatAppleLossless:
        compressionType = kAirPlayCompressionType_ALAC;
        break;
    case kAudioFormatLinearPCM:
        compressionType = kAirPlayCompressionType_PCM;
        break;
    case kAudioFormatMPEG4AAC:
        compressionType = kAirPlayCompressionType_AAC_LC;
        break;
    case kAudioFormatMPEG4AAC_ELD:
        compressionType = kAirPlayCompressionType_AAC_ELD;
        break;
    case kAudioFormatOpus:
        compressionType = kAirPlayCompressionType_OPUS;
        break;
    default:
        compressionType = 0;
    }
...
CFDictionaryRef AirPlayCreateModesDictionary(const AirPlayModeChanges* inChanges, CFStringRef inReason, OSStatus* outErr)
{
    ...
    if (inChanges->screen.type != kAirPlayTransferType_NotApplicable) {
        ...
        if (inChanges->screen.borrowOrUnborrowConstraint != kAirPlayConstraint_NotApplicable) {
            if (inChanges->screen.type == kAirPlayTransferType_Take)
                key = CFSTR(kAirPlayKey_BorrowConstraint);
            else if (inChanges->screen.type == kAirPlayTransferType_Borrow)
                key = CFSTR(kAirPlayKey_UnborrowConstraint);
            else {
                dlogassert("Bad borrow/unborrow constraint");
                err = kParamErr;
                goto exit;
            }
    ...
    if (inChanges->mainAudio.type != kAirPlayTransferType_NotApplicable) {
        ...
        if (inChanges->mainAudio.borrowOrUnborrowConstraint != kAirPlayConstraint_NotApplicable) {
            if (inChanges->mainAudio.type == kAirPlayTransferType_Take)
                key = CFSTR(kAirPlayKey_BorrowConstraint);
            else if (inChanges->mainAudio.type == kAirPlayTransferType_Borrow)
                key = CFSTR(kAirPlayKey_UnborrowConstraint);
            else {
                dlogassert("Bad borrow/unborrow constraint");
                err = kParamErr;
    ...
    if (appStates)
        CFDictionarySetValue(params, CFSTR(kAirPlayKey_AppStates), appStates);
    if (resources)
        CFDictionarySetValue(params, CFSTR(kAirPlayKey_Resources), resources);
    if (inReason)
        CFDictionarySetValue(params, CFSTR(kAirPlayKey_ReasonStr), inReason);
    result = params;
    params = NULL;
    err = kNoErr;
    ...
    uint8_t outIV[16])
{
    ...
    screenStreamKeySaltLen = asprintf(&screenStreamKeySalt, "%s%llu", kAirPlayEncryptionStreamPrefix_Key, (unsigned long long)inScreenStreamConnectionID);
    screenStreamIVSaltLen = asprintf(&screenStreamIVSalt, "%s%llu", kAirPlayEncryptionStreamPrefix_IV, (unsigned long long)inScreenStreamConnectionID);
...
OSStatus RTPJitterBufferPutBusyNode(RTPJitterBufferContext* ctx, RTPPacketNode* inNode)
{
    ...
    {
        if (Mod32_LE(node->pkt.pkt.rtp.header.ts, ts))
            break;
    }
