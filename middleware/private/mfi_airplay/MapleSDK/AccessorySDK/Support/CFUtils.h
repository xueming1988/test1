...
*/
typedef OSStatus (*CFObjectControlFunc)(
    CFTypeRef inObject,
...
*/
typedef CFTypeRef (*CFObjectCopyPropertyFunc)(
    CFTypeRef inObject,
    CFObjectFlags inFlags,
...
*/
typedef OSStatus (*CFObjectSetPropertyFunc)(
    CFTypeRef inObject,
    CFObjectFlags inFlags,
    CFStringRef inProperty,
    CFTypeRef inQualifier,
...
//---------------------------------------------------------------------------------------------------------------------------
/*!    @function    CFArrayMapper
 @abstract    A function type used by CFArrayCreateMap() to transform values.
 */
typedef CFTypeRef (*CFArrayMapper)(CFTypeRef anObject, void* info);

//---------------------------------------------------------------------------------------------------------------------------
/*!    @function    CFArrayCreateMap
 @abstract    Creates a new array by transforming each element in an existing array.
 */
CF_RETURNS_RETAINED CFArrayRef CFArrayCreateMap(CFArrayRef array, CFArrayMapper createMap, void* info);

/*!    @function    CFArrayCreateDifference
 @abstract    Remove the elements in subtrahend from those in minuend.
 
 */
CF_RETURNS_RETAINED CFArrayRef CFArrayCreateDifference(CFArrayRef minuend, CFArrayRef subtrahend);
...
#if (CFLITE_ENABLED)
#define CFStringAppend(str, append) CFStringAppendF((str), "%@", (append))
#endif
