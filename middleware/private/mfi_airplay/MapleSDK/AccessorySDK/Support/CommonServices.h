/*
	Copyright (C) 2002-2019 Apple Inc. All Rights Reserved. Not to be used or disclosed without permission from Apple.
...
// FALL_THROUGH -- Portable way to indicate that a switch case should fall through to the next case.
...
STATIC_INLINE id arc_safe_retain(id x)
{
    return (x);
}
...
#define arc_safe_Block_release(X) \
    do {                          \
    } while (0)

#define arc_safe_dispatch_release(x) \
    do {                             \
    } while (0)
#define arc_safe_dispatch_retain(x) \
    do {                            \
    } while (0)

#define arc_safe_os_release(x) \
    do {                       \
    } while (0)
#define arc_safe_os_retain(x) \
    do {                      \
    } while (0)

#define arc_safe_xpc_release(x) \
    do {                        \
    } while (0)
#define arc_safe_xpc_retain(x) \
    do {                       \
    } while (0)
...
// _Nullable -- Marks a pointer as potentially being NULL.

#if (!__has_feature(nullability))
#define _Nullable
#endif

// _Nonnull -- Marks a pointer as not being NULL as part of the API contract.
...
#if (COMPILER_GCC)
#define __ROUTINE__ (__extension__ __PRETTY_FUNCTION__)
#elif (COMPILER_ARM_REALVIEW)
...
#define SHA256_DIGEST_LENGTH 32
#define SHA256_CTX SHA256_CTX_compat
#define SHA256_Init(CTX) SHA256_Init_compat((CTX))
#define SHA256_Update(CTX, PTR, LEN) SHA256_Update_compat((CTX), (PTR), (LEN))
#define SHA256_Final(DIGEST, CTX) SHA256_Final_compat((DIGEST), (CTX))
#define SHA256(PTR, LEN, DIGEST) SHA256_compat((PTR), (LEN), DIGEST)
...
#if ((defined(__LP64__) && __LP64__) || defined(_WIN64) || defined(EFI64) || defined(EFIX64) || TARGET_CPU_X86_64 || TARGET_CPU_PPC64)
...
#if ((defined(TARGET_RT_BIG_ENDIAN) && !TARGET_RT_BIG_ENDIAN) || (defined(BYTE_ORDER) && defined(LITTLE_ENDIAN) && (BYTE_ORDER == LITTLE_ENDIAN)) || (defined(_BYTE_ORDER) && defined(_LITTLE_ENDIAN) && (_BYTE_ORDER == _LITTLE_ENDIAN)) || (defined(__BYTE_ORDER) && defined(__LITTLE_ENDIAN) && (__BYTE_ORDER == __LITTLE_ENDIAN)) || (COMPILER_ARM_REALVIEW && !defined(__BIG_ENDIAN)) || (defined(IL_LITTLE_ENDIAN) && IL_LITTLE_ENDIAN) || defined(__LITTLE_ENDIAN__) || defined(EFI_NET_LITTLE_ENDIAN) || defined(__LITTLEENDIAN__) || defined(__LittleEndian) || defined(IP_LITTLE_ENDIAN) || TARGET_CPU_X86 || TARGET_CPU_X86_64 || defined(__MIPSEL__) || defined(MIPSEL) || defined(vax) || defined(__ARMEL__))
...
#if ((defined(TARGET_RT_LITTLE_ENDIAN) && !TARGET_RT_LITTLE_ENDIAN) || (defined(BYTE_ORDER) && defined(BIG_ENDIAN) && (BYTE_ORDER == BIG_ENDIAN)) || (defined(_BYTE_ORDER) && defined(_BIG_ENDIAN) && (_BYTE_ORDER == _BIG_ENDIAN)) || (defined(__BYTE_ORDER) && defined(__BIG_ENDIAN) && (__BYTE_ORDER == __BIG_ENDIAN)) || (COMPILER_ARM_REALVIEW && defined(__BIG_ENDIAN)) || (defined(IL_BIG_ENDIAN) && IL_BIG_ENDIAN) || defined(__BIG_ENDIAN__) || defined(EFI_NET_BIG_ENDIAN) || defined(__BIGENDIAN__) || defined(__BigEndian) || defined(IP_BIG_ENDIAN) || TARGET_CPU_PPC || TARGET_CPU_PPC64 || defined(__MIPSEB__) || defined(MIPSEB) || defined(sparc) || defined(mc68000) || defined(sel) || defined(__ARMEB__))
...
#define check_compile_time_code(X)                      \
    do {                                                \
        _Pragma(warning(push))                          \
            _Pragma(warning(disable : 6326)) switch (0) \
        {                                               \
        case 0:                                         \
        case X:;                                        \
        }                                               \
...
#define ReadBig16(PTR) \
    ((uint16_t)(       \
        (((uint16_t)((uint8_t*)(PTR))[0]) << 8) | ((uint16_t)((uint8_t*)(PTR))[1])))

#define ReadBig24(PTR) \
    ((uint32_t)(       \
        (((uint32_t)((uint8_t*)(PTR))[0]) << 16) | (((uint32_t)((uint8_t*)(PTR))[1]) << 8) | ((uint32_t)((uint8_t*)(PTR))[2])))

#define ReadBig32(PTR) \
    ((uint32_t)(       \
        (((uint32_t)((uint8_t*)(PTR))[0]) << 24) | (((uint32_t)((uint8_t*)(PTR))[1]) << 16) | (((uint32_t)((uint8_t*)(PTR))[2]) << 8) | ((uint32_t)((uint8_t*)(PTR))[3])))

#define ReadBig48(PTR) \
    ((uint64_t)(       \
        (((uint64_t)((uint8_t*)(PTR))[0]) << 40) | (((uint64_t)((uint8_t*)(PTR))[1]) << 32) | (((uint64_t)((uint8_t*)(PTR))[2]) << 24) | (((uint64_t)((uint8_t*)(PTR))[3]) << 16) | (((uint64_t)((uint8_t*)(PTR))[4]) << 8) | ((uint64_t)((uint8_t*)(PTR))[5])))
...
#define ReadLittle24(PTR) \
    ((uint32_t)(          \
        ((uint32_t)((uint8_t*)(PTR))[0]) | (((uint32_t)((uint8_t*)(PTR))[1]) << 8) | (((uint32_t)((uint8_t*)(PTR))[2]) << 16)))
...
#define ReadLittle32(PTR) \
    ((uint32_t)(          \
        ((uint32_t)((uint8_t*)(PTR))[0]) | (((uint32_t)((uint8_t*)(PTR))[1]) << 8) | (((uint32_t)((uint8_t*)(PTR))[2]) << 16) | (((uint32_t)((uint8_t*)(PTR))[3]) << 24)))
#endif

#define ReadLittle48(PTR) \
    ((uint64_t)(          \
        ((uint64_t)((uint8_t*)(PTR))[0]) | (((uint64_t)((uint8_t*)(PTR))[1]) << 8) | (((uint64_t)((uint8_t*)(PTR))[2]) << 16) | (((uint64_t)((uint8_t*)(PTR))[3]) << 24) | (((uint64_t)((uint8_t*)(PTR))[4]) << 32) | (((uint64_t)((uint8_t*)(PTR))[5]) << 40)))
...
#define ReadLittle64(PTR) \
    ((uint64_t)(          \
        ((uint64_t)((uint8_t*)(PTR))[0]) | (((uint64_t)((uint8_t*)(PTR))[1]) << 8) | (((uint64_t)((uint8_t*)(PTR))[2]) << 16) | (((uint64_t)((uint8_t*)(PTR))[3]) << 24) | (((uint64_t)((uint8_t*)(PTR))[4]) << 32) | (((uint64_t)((uint8_t*)(PTR))[5]) << 40) | (((uint64_t)((uint8_t*)(PTR))[6]) << 48) | (((uint64_t)((uint8_t*)(PTR))[7]) << 56)))
#endif
...
STATIC_INLINE Float32 ReadBigFloat32(const void *p)
{
    Value32 v32;
    v32.u32 = ReadBig32(p);
    return (v32.f32);
}
STATIC_INLINE Float64 ReadBigFloat64(const void *p)
{
    Value64 v64;
    v64.u64 = ReadBig64(p);
    return (v64.f64);
}
STATIC_INLINE Float32 ReadLittleFloat32(const void *p)
{
    Value32 v32;
    v32.u32 = ReadLittle32(p);
    return (v32.f32);
}
STATIC_INLINE Float64 ReadLittleFloat64(const void *p)
{
    Value64 v64;
    v64.u64 = ReadLittle64(p);
    return (v64.f64);
}

STATIC_INLINE void WriteBigFloat32(void *p, Float32 x)
{
    Value32 v32;
    v32.f32 = x;
    WriteBig32(p, v32.u32);
}
STATIC_INLINE void WriteBigFloat64(void *p, Float64 x)
{
    Value64 v64;
    v64.f64 = x;
    WriteBig64(p, v64.u64);
}
STATIC_INLINE void WriteLittleFloat32(void *p, Float32 x)
{
    Value32 v32;
    v32.f32 = x;
    WriteLittle32(p, v32.u32);
}
STATIC_INLINE void WriteLittleFloat64(void *p, Float64 x)
{
    Value64 v64;
    v64.f64 = x;
    WriteLittle64(p, v64.u64);
}
...
#endif
STATIC_INLINE const char *getprogname(void)
{
    return (__progname);
}
#endif
...
STATIC_INLINE void free(void* inPtr)
{
    _FREE(inPtr, M_TEMP);
}
...
#define SockAddrIsIPv4LinkLocal(X)                                                                                                                             \
    ((((const struct sockaddr*)(X))->sa_family == AF_INET)                                                                                                     \
            ? ((((uint8_t*)(&((const struct sockaddr_in*)(X))->sin_addr))[0] == 169) && (((uint8_t*)(&((const struct sockaddr_in*)(X))->sin_addr))[1] == 254)) \
            : 0)

#define SockAddrIsIPv6LinkLocal(X)                                                 \
    ((((const struct sockaddr*)(X))->sa_family == AF_INET6)                        \
            ? IN6_IS_ADDR_LINKLOCAL(&((const struct sockaddr_in6*)(X))->sin6_addr) \
            : 0)
...
#define SockAddrFamilyToString(X) \
    (((X) == AF_INET) ? "AF_INET" : (((X) == AF_INET6) ? "AF_INET6" : (((X) == AF_LINK) ? "AF_LINK" : "UNKNOWN")))
#elif (defined(AF_INET6))
#define SockAddrFamilyToString(X) \
    (((X) == AF_INET) ? "AF_INET" : (((X) == AF_INET6) ? "AF_INET6" : "UNKNOWN"))
#elif (defined(AF_LINK))
#define SockAddrFamilyToString(X) \
    (((X) == AF_INET) ? "AF_INET" : (((X) == AF_LINK) ? "AF_LINK" : "UNKNOWN"))
#else
#define SockAddrFamilyToString(X) \
    (((X) == AF_INET) ? "AF_INET" : "UNKNOWN")
#endif

// Determines if a 16-byte IPv6 address is an IPv4-mapped IPv6 address.

#define IsIPv4MappedIPv6Address(A) \
    ((((const uint8_t*)(A))[0] == 0) && (((const uint8_t*)(A))[1] == 0) && (((const uint8_t*)(A))[2] == 0) && (((const uint8_t*)(A))[3] == 0) && (((const uint8_t*)(A))[4] == 0) && (((const uint8_t*)(A))[5] == 0) && (((const uint8_t*)(A))[6] == 0) && (((const uint8_t*)(A))[7] == 0) && (((const uint8_t*)(A))[8] == 0) && (((const uint8_t*)(A))[9] == 0) && (((const uint8_t*)(A))[10] == 0xFF) && (((const uint8_t*)(A))[11] == 0xFF))

// Determines if a 16-byte IPv6 address is an IPv4-compatible IPv6 address.

#define IsIPv4CompatibleIPv6Address(A) \
    (((((const uint8_t*)(A))[0] == 0) && (((const uint8_t*)(A))[1] == 0) && (((const uint8_t*)(A))[2] == 0) && (((const uint8_t*)(A))[3] == 0) && (((const uint8_t*)(A))[4] == 0) && (((const uint8_t*)(A))[5] == 0) && (((const uint8_t*)(A))[6] == 0) && (((const uint8_t*)(A))[7] == 0) && (((const uint8_t*)(A))[8] == 0) && (((const uint8_t*)(A))[9] == 0) && (((const uint8_t*)(A))[10] == 0) && (((const uint8_t*)(A))[11] == 0)) && !((((const uint8_t*)(A))[12] == 0) && (((const uint8_t*)(A))[13] == 0) && (((const uint8_t*)(A))[14] == 0) && (((const uint8_t*)(A))[15] == 0)) && !((((const uint8_t*)(A))[12] == 0) && (((const uint8_t*)(A))[13] == 0) && (((const uint8_t*)(A))[14] == 0) && (((const uint8_t*)(A))[15] == 1)))
...
#define ASBD_FillALAC(FMT, RATE, BITS, CHANNELS)                                                                                                                                                                     \
    do {                                                                                                                                                                                                             \
        ...
        (FMT)->mFormatFlags = ((BITS) == 16) ? kAppleLosslessFormatFlag_16BitSourceData : ((BITS) == 20) ? kAppleLosslessFormatFlag_20BitSourceData : ((BITS) == 24) ? kAppleLosslessFormatFlag_24BitSourceData : 0; \
        (FMT)->mBytesPerPacket = 0;                                                                                                                                                                                  \
...
#define ASBD_FillPCM(FMT, RATE, VALID_BITS, TOTAL_BITS, CHANNELS)                                                                                                                            \
    do {                                                                                                                                                                                     \
        ...
        (FMT)->mFormatFlags = kAudioFormatFlagsNativeEndian | kAudioFormatFlagIsSignedInteger | (((VALID_BITS) == (TOTAL_BITS)) ? kAudioFormatFlagIsPacked : kAudioFormatFlagIsAlignedHigh); \
...
#define ASBD_MakePCM(RATE, VALID_BITS, TOTAL_BITS, CHANNELS)                                                                                                                                                  \
    {                                                                                                                                                                                                         \
        /* mSampleRate			*/ (RATE),                                                                                                                                                            \
            ...
            /* mFormatFlags 		*/ kAudioFormatFlagsNativeEndian | kAudioFormatFlagIsSignedInteger | (((VALID_BITS) == (TOTAL_BITS)) ? kAudioFormatFlagIsPacked : kAudioFormatFlagIsAlignedHigh), \
...
#define CFStringLocalizedStandardCompare(A, B)        \
    CFStringCompare((A), (B), (CFStringCompareFlags)( \
                                  kCFCompareCaseInsensitive | kCFCompareLocalized | kCFCompareNumerically | kCFCompareWidthInsensitive | kCFCompareForcedOrdering))
#else
#define CFStringLocalizedStandardCompare(A, B) \
...
#if (TARGET_OS_DARWIN || TARGET_OS_QNX || TARGET_OS_NETBSD)
...
#define PtrsOverlap(PTR1, LEN1, PTR2, LEN2) \
    (!(((((uintptr_t)(PTR1)) + (LEN1)) <= ((uintptr_t)(PTR2))) || (((uintptr_t)(PTR1)) >= (((uintptr_t)(PTR2)) + (LEN2)))))
...
#define MinPowerOf2BytesForValue(X) ( \
    ((X)&UINT64_C(0xFFFFFFFF00000000)) ? 8 : ((X)&UINT64_C(0x00000000FFFF0000)) ? 4 : ((X)&UINT64_C(0x000000000000FF00)) ? 2 : 1)
...
*/
#define increment_wrap(VAR, WRAP) \
    do {                          \
        ++(VAR);                  \
        if ((VAR) == 0) {         \
            (VAR) = (WRAP);       \
...
*/
#define increment_saturate(VAR, MAX) \
    do {                             \
        if ((VAR) < (MAX)) {         \
            ++(VAR);                 \
        }                            \
...
#define median_of_3(x0, x1, x2) \
    (((x0) > (x1)) ? ((x1) > (x2)) ? (x1) : ((x2) > (x0)) ? (x0) : (x2) : ((x1) < (x2)) ? (x1) : ((x2) < (x0)) ? (x0) : (x2))
...
#define median_of_5(a, b, c, d, e)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
    ((b) < (a) ? (d) < (c) ? (b) < (d) ? (a) < (e) ? (a) < (d) ? (e) < (d) ? (e) : (d) : (c) < (a) ? (c) : (a) : (e) < (d) ? (a) < (d) ? (a) : (d) : (c) < (e) ? (c) : (e) : (c) < (e) ? (b) < (c) ? (a) < (c) ? (a) : (c) : (e) < (b) ? (e) : (b) : (b) < (e) ? (a) < (e) ? (a) : (e) : (c) < (b) ? (c) : (b) : (b) < (c) ? (a) < (e) ? (a) < (c) ? (e) < (c) ? (e) : (c) : (d) < (a) ? (d) : (a) : (e) < (c) ? (a) < (c) ? (a) : (c) : (d) < (e) ? (d) : (e) : (d) < (e) ? (b) < (d) ? (a) < (d) ? (a) : (d) : (e) < (b) ? (e) : (b) : (b) < (e) ? (a) < (e) ? (a) : (e) : (d) < (b) ? (d) : (b) \
               : (d) < (c) ? (a) < (d) ? (b) < (e) ? (b) < (d) ? (e) < (d) ? (e) : (d) : (c) < (b) ? (c) : (b) : (e) < (d) ? (b) < (d) ? (b) : (d) : (c) < (e) ? (c) : (e) : (c) < (e) ? (a) < (c) ? (b) < (c) ? (b) : (c) : (e) < (a) ? (e) : (a) : (a) < (e) ? (b) < (e) ? (b) : (e) : (c) < (a) ? (c) : (a)                                                                                                                                                                                                                                                                                     \
...
#define ForgetCustomEx(X, STOPPER, DELETER) \
    do {                                    \
        if (*(X)) {                         \
            STOPPER(*(X));                  \
            DELETER(*(X));                  \
...
#define ObjCForgetCustom(X, STOPPER) \
    do {                             \
        [*(X)STOPPER];               \
        arc_safe_release(*(X));      \
        *(X) = nil;                  \
...
#define dispatch_release_null_safe(X)       \
    do {                                    \
        if ((X))                            \
...
#define ForgetIOKitKernelObject(X) \
    do {                           \
        if (*(X)) {                \
            (*(X))->release();     \
            *(X) = NULL;           \
...
#define ForgetObjectiveCObject(X) \
    do {                          \
        arc_safe_release(*(X));   \
        *(X) = nil;               \
    } while (0)
#define ForgetPtrLen(PTR, LEN) \
    do {                       \
        ForgetMem((PTR));      \
        *(LEN) = 0;            \
    } while (0)
#define ForgetPtrLenSecure(PTR, LEN)       \
    do {                                   \
        if (*(PTR)) {                      \
            MemZeroSecure(*(PTR), *(LEN)); \
        }                                  \
        ForgetPtrLen((PTR), (LEN));        \
    } while (0)
#define ForgetVxSem(X)       \
    do {                     \
        if (*(X)) {          \
            semDelete(*(X)); \
            *(X) = 0;        \
...
#define xpc_release_null_safe(X)       \
    do {                               \
        if ((X))                       \
...
#define ReplaceBlock(BLOCK_PTR, NEW_BLOCK)                                        \
    do {                                                                          \
        ...
        if (*(BLOCK_PTR))                                                         \
            arc_safe_Block_release(*(BLOCK_PTR));                                 \
...
#define ReplaceCF(OBJECT_PTR, NEW_OBJECT)                          \
    do {                                                           \
        ...
        CFTypeRef ReplaceCF_newObject = (NEW_OBJECT);              \
                                                                   \
        if (ReplaceCF_newObject)                                   \
            CFRetain(ReplaceCF_newObject);                         \
        *ReplaceCF_objectPtr = ReplaceCF_newObject;                \
        if (ReplaceCF_oldObject)                                   \
            CFRelease(ReplaceCF_oldObject);                        \
                                                                   \
    } while (0)
...
#define ReplaceDispatchQueue(QUEUE_PTR, NEW_QUEUE)                      \
    do {                                                                \
        dispatch_queue_t ReplaceDispatchQueue_TempQueue = (NEW_QUEUE);  \
                                                                        \
        if (!ReplaceDispatchQueue_TempQueue)                            \
            ReplaceDispatchQueue_TempQueue = dispatch_get_main_queue(); \
        arc_safe_dispatch_retain(ReplaceDispatchQueue_TempQueue);       \
        if (*(QUEUE_PTR))                                               \
            arc_safe_dispatch_release(*(QUEUE_PTR));                    \
...
#endif
#else
#if (!defined(__cplusplus) && (!defined(__bool_true_false_are_defined) || !__bool_true_false_are_defined) && !defined(bool) && !defined(_RWOS_H_) && !defined(__IOKIT_IOTYPES_H))
#define COMMON_SERVICES_NEEDS_BOOL 1
#else
#define COMMON_SERVICES_NEEDS_BOOL 0
#endif
...
#define NumVersionBuild(MAJOR, MINOR, BUGFIX, STAGE, REV) \
    ((((MAJOR)&0xFF) << 24) | (((MINOR)&0x0F) << 20) | (((BUGFIX)&0x0F) << 16) | (((STAGE)&0xFF) << 8) | (((REV)&0xFF)))
...
#define NumVersionCompare(A, B) \
    ((((A)&0xFFFFFF00U) < ((B)&0xFFFFFF00U)) ? -1 : (((A)&0xFFFFFF00U) > ((B)&0xFFFFFF00U)) ? 1 : ((((A)-1) & 0xFF) < (((B)-1) & 0xFF)) ? -1 : ((((A)-1) & 0xFF) > (((B)-1) & 0xFF)) ? 1 : 0)
...
#define HexCharToValue(X) \
    ((((X) >= '0') && ((X) <= '9')) ? ((X) - '0') : (((X) >= 'A') && ((X) <= 'F')) ? (10 + ((X) - 'A')) : (((X) >= 'a') && ((X) <= 'f')) ? (10 + ((X) - 'a')) : 0)

#define IsHexPair(PTR) \
    (isxdigit_safe(((const unsigned char*)(PTR))[0]) && isxdigit_safe(((const unsigned char*)(PTR))[1]))

#define HexPairToByte(PTR) ((uint8_t)( \
    (HexCharToValue(((const unsigned char*)(PTR))[0]) << 4) | HexCharToValue(((const unsigned char*)(PTR))[1])))
...
#define IsOctalTriple(PTR) \
    (((((const unsigned char*)(PTR))[0] >= '0') && (((const unsigned char*)(PTR))[0] <= '3')) && isoctal_safe(((const unsigned char*)(PTR))[1]) && isoctal_safe(((const unsigned char*)(PTR))[2]))

#define OctalTripleToByte(PTR) ((uint8_t)( \
    (OctalCharToValue(((const unsigned char*)(PTR))[0]) * 64) | (OctalCharToValue(((const unsigned char*)(PTR))[1]) * 8) | OctalCharToValue(((const unsigned char*)(PTR))[2])))
...
#define MinimalMutexEnsureInitialized(NAME) \
    do {                                    \
    } while (0)
#define MinimalMutexEnsureFinalized(NAME) \
    do {                                  \
    } while (0)
#define MinimalMutexLock(NAME) \
    do {                       \
    } while (!OSSpinLockTry(&NAME))
...
#elif (TARGET_OS_WINDOWS)
#define MinimalMutexDefine(NAME)  \
    static CRITICAL_SECTION NAME; \
    static LONG NAME##State = 0
