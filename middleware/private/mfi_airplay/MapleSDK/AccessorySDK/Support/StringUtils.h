...
#define kHexToData_DefaultFlags (kHexToData_IgnoreWhitespace | kHexToData_IgnoreDelimiters | kHexToData_IgnorePrefixes)
...
#define IsTrueString(PTR, LEN) ((Boolean)( \
    (strnicmpx((PTR), (LEN), "true") == 0) || (strnicmpx((PTR), (LEN), "yes") == 0) || (strnicmpx((PTR), (LEN), "y") == 0) || (strnicmpx((PTR), (LEN), "on") == 0) || (strnicmpx((PTR), (LEN), "1") == 0)))
...
#define IsFalseString(PTR, LEN) ((Boolean)( \
    (strnicmpx((PTR), (LEN), "false") == 0) || (strnicmpx((PTR), (LEN), "no") == 0) || (strnicmpx((PTR), (LEN), "n") == 0) || (strnicmpx((PTR), (LEN), "off") == 0) || (strnicmpx((PTR), (LEN), "0") == 0)))
...
#define MapCountToOrSeparator(COUNT, TOTAL_COUNT) (                                                  \
    ((COUNT) > 0) ? ((TOTAL_COUNT) > 2) ? (((COUNT) + 1) == (TOTAL_COUNT)) ? ", or " : ", " : " or " \
                  : "")
