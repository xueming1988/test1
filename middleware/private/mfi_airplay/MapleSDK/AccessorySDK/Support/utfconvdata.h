...
static const size_t __UniCharDecompositionTableLength = (sizeof(__CFUniCharDecompositionTable) / (sizeof(uint16_t) * 2));
...
static const size_t __CFUniCharPrecompositionTableLength = (sizeof(__CFUniCharPrecompSourceTable) / (sizeof(uint32_t) * 2));
