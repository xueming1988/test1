...
struct HTTPClientAuthorizationInfo {
    ...
    Boolean uppercaseHex; // true=Use uppercase hex digits to support old iTunes.
...
#define MIMETypeIsPlist(PTR, LEN) \
    ((Boolean)((strnicmpx((PTR), (LEN), kMIMEType_AppleBinaryPlist) == 0) || (strnicmpx((PTR), (LEN), kMIMEType_AppleXMLPlist) == 0)))
