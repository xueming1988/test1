...
#include <sys/ioctl.h>
#include <pthread.h>
#include "../libmpdemux/demux_rtsp.h"
...
static void *rtsp_server_thread_func(void *arg)
{
	...
	ao_run_rstp(&audio_buffer,buffer_size,write_ptr,read_ptr,ao_mutex);
...
static int init(int rate_hz, int channels, int format, int flags)
{
	...
	ao_data.format = AF_FORMAT_S16_BE;  //AF_FORMAT_S16_LE
	ao_data.channels = 2;
	bytes_per_sample = 32;
