...
extern const ad_functions_t mpcodecs_ad_libbypass;
...
extern const ad_functions_t mpcodecs_ad_libwma;
extern const ad_functions_t mpcodecs_ad_libdradec;
...
const ad_functions_t * const mpcodecs_ad_drivers[] =
{
  ...
  &mpcodecs_ad_libwma,
#endif
#ifdef HAVE_LIBDRADEC
  &mpcodecs_ad_libdradec,
#endif
  NULL
};
