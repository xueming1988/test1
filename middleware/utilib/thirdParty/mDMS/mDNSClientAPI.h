...
// can raise the value of this constant to a suitable value (at the expense of increased memory usage).
	...
	extern void *   mDNSPlatformMemAllocate (mDNSu32 len, const char *file, int line, const char *func);
	extern void     mDNSPlatformMemFree     (void *mem, const char *file, int line, const char *func);
