...
#ifndef _MPLAYER_AUDIO_FILE_SOURCE_HH
#define _MPLAYER_AUDIO_FILE_SOURCE_HH
...
class MplayerFileSource: public AudioInputDevice {
public:

  static MplayerFileSource* createNew(UsageEnvironment& env, char ** pbuffer,
										  unsigned int * psize,
										  unsigned int * pwprt,
										  unsigned int * prprt,
...
protected:
  MplayerFileSource(UsageEnvironment& env, char ** pbuffer,
										  unsigned int * psize,
										  unsigned int * pwprt,
										  unsigned int * prprt,
										  pthread_mutex_t* pmutex,
