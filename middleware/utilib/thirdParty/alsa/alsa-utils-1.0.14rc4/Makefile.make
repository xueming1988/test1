...
ifeq ($(TARGETENV),ARM)
DEF_CPPFLAGS				:= CPPFLAGS=-I$(RELEASE_DIR)/include:$(RELEASE_DIR)/include/upnp
...
DEF_LDFLAGS				:= LDFLAGS=-L$(RELEASE_DIR)/lib
DEF_PKG_CONFIG_LIBDIR	:= 
CONFIGOPTION			:= --host=mipsel-linux
...
Makefile:  
	$(DEF_CPPFLAGS) $(DEF_LDFLAGS) $(DEF_PKG_CONFIG_LIBDIR)  ./configure  $(CONFIGOPTION) --prefix=$(RELEASE_DIR) --disable-xmlto --disable-alsamixer  
