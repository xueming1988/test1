...
DEF_CFLAGS							:= CFLAGS='$(CFLAGS) -Wno-error -I$(RELEASE_DIR)/include'
...
DEF_CFLAGS							:= CFLAGS='$(CFLAGS) -Os -Wno-error -I$(RELEASE_DIR)/include  -I$(COMMON_INC_DIR)'
DEF_PKG_CONFIG_LIBDIR		:=PKG_CONFIG_PATH=$(RELEASE_DIR)/lib/pkgconfig
...
Makefile:configure  
	$(DEF_CFLAGS) ./configure --prefix=$(RELEASE_DIR) $(DEBUG_OPT) $(CONFIGOPTION) --enable-shared  --with-configdir=/system/workdir/lib/alsa
