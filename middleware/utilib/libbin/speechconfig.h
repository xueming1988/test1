...
class SpeechConfig
{
    public:
        ...
        SpeechConfig& setFormat(char *format) {m_format = string(format);return *this;}
        ...
        SpeechConfig& setMuteGateMs(int mute_gate_ms) {m_mute_gate_ms = mute_gate_ms; return *this;}
    private:
        string m_host;
        string m_port;
        string m_appkey;
